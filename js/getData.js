...
const displayPhotos = (photoResults) => {
  ...
  let genHtmlContent ='<div class="container-fluid"><div class="row justify-content-md-center">';
    photoResults.forEach(({ id, author, download_url, width }) => {
        genHtmlContent += `
            ...
            <a target="_blank" href=${download_url} class="btn btn-outline-dark col-12">Download Photo!</a>
            </div></div></div>`;
    }); 
